...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      hero_badge: "Frutas Tropicales Premium de Exportación",
      hero_title: "Llevamos la Frescura y Sabor del Trópico a los Mercados del Mundo",
      hero_desc: "Productores y exportadores líderes de <strong>Banano Cavendish</strong>, <strong>Mango</strong>, <strong>Pitahaya Roja (Red Dragon)</strong> y <strong>Pitahaya Amarilla de Palora</strong>. Estrictos estándares fitosanitarios, trazabilidad completa y cadena de frío ininterrumpida.",
      ...
      about_p2: "Nuestras fincas aliadas y propias en los valles más privilegiados de Ecuador garantizan un fruto con nutrientes excepcionales, dulzura natural (grados Brix óptimos) y una vida útil prolongada en anaquel gracias a rigurosos procesos de postcosecha.",
      ...
      prod_title: "Nuestras Frutas Tropicales de Clase Mundial",
      prod_subtitle: "Seleccionadas a mano bajo los más rigurosos estándares de peso, calibre, color y maduración.",
      ...
      banano_desc: "Reconocido mundialmente por su sabor inigualable, textura suave y excelente conservación. Cultivado en suelos volcánicos de alta fertilidad.",
      mango_name: "Mango de Exportación (Tommy & Kent)",
      mango_desc: "Mangos jugosos, de coloración vibrante roja/amarilla, aroma dulce y pulpa firme sin fibra. Con tratamiento hidrotérmico certificado USDA-APHIS.",
      pitared_name: "Pitahaya Roja (Red Dragon Fruit)",
      pitared_desc: "Cáscara fucsia brillante con pulpa púrpura/roja intensa llena de antioxidantes. Excelente vida comercial y gran atractivo visual para el canal gourmet y retail.",
      pitayellow_name: "Pitahaya Amarilla (Yellow Dragon)",
      pitayellow_desc: "La famosa fruta dorada de Palora. Pulpa translúcida crujiente, dulzura insuperable y propiedades digestivas. Altísima demanda en EE.UU., Europa y Asia.",
      ...
      footer_desc: "Exportación de frutas tropicales de alta gama hacia América del Norte, Europa, Asia y Medio Oriente. Frescura, trazabilidad y compromiso con la calidad.",
    ...
    en: {
      ...
      hero_badge: "Premium Tropical Export Fruits",
      hero_title: "Delivering Tropical Freshness & Flavor to Global Markets",
      hero_desc: "Leading growers and exporters of <strong>Cavendish Bananas</strong>, <strong>Fresh Mangoes</strong>, <strong>Red Dragon Fruit</strong>, and <strong>Yellow Dragon Fruit (Palora)</strong>. Strict phytosanitary compliance, complete farm traceability, and unbroken cold chain.",
      ...
      prod_title: "Our World-Class Tropical Fruits",
      prod_subtitle: "Hand-harvested and graded under the strictest international weight, caliber, color, and maturity standards.",
      ...
      banano_desc: "Internationally acclaimed for its smooth texture, rich natural flavor, and exceptional transit resilience. Grown in volcanic mineral-rich soils.",
      ...
      pitayellow_desc: "The world-famous golden fruit from Palora. Crunchy translucent flesh, unmatched honey sweetness, and digestive benefits. High demand across USA, Europe, and Asia.",
      ...
      form_fruit: "Fruit of Interest",
      form_fruit_placeholder: "Select fruit...",
      ...
      map_text: "Dispatches from the Pacific's main deep-sea terminals to the world",

      modal_close: "Close",
      btn_quote_this: "Quote this Product",
      wa_tooltip: "Chat with an export specialist!",
      footer_desc: "Premium tropical fruit exports to North America, Europe, Asia, and the Middle East. Peak freshness, full traceability, and uncompromising quality.",
      footer_fruits: "Our Fruits",
      footer_nav: "Quick Links",
      footer_certs: "Standards",
      footer_rights: "All rights reserved.",
      footer_global: "Exporting fresh taste from Ecuador to the world 🌍"
    }
  };
  ...
  // ==========================================
  // TECHNICAL SPECIFICATION DATA & MODAL
  // ==========================================
  const productSpecs = {
    banano: {
      ...
      specs_es: [
        { label: "Variedad", val: "Musa acuminata (Cavendish - Williams / Gran Enano)" },
        { label: "Origen", val: "Ecuador (Guayas, Los Ríos, El Oro)" },
        { label: "Calibración", val: "Grado 39 a 46 mm (39/46)" },
        { label: "Longitud del Dedo", val: "Mínimo 7.5 a 8.5 pulgadas" },
        { label: "Dedos por Clúster", val: "4 a 8 dedos seleccionados" },
        { label: "Empaque Primario", val: "Bolsa al vacío Banavac / Polietileno microperforado" },
        { label: "Caja de Exportación", val: "Cartón corrugado 18.14 kg (40 lb) o 19.43 kg neto" },
        { label: "Capacidad por Contenedor", val: "1,080 cajas en contenedor Reefer de 40 pies (Palletizado)" },
        { label: "Temperatura de Transporte", val: "13.2°C - 13.5°C con ventilación controlada" },
        { label: "Vida Útil en Tránsito", val: "Hasta 35 - 40 días bajo atmósfera controlada" }
      ],
      specs_en: [
        { label: "Variety", val: "Musa acuminata (Cavendish - Williams / Grand Nain)" },
        { label: "Origin", val: "Ecuador (Guayas, Los Ríos, El Oro provinces)" },
        { label: "Calibration", val: "Grade 39 to 46 mm (39/46)" },
        { label: "Finger Length", val: "Minimum 7.5 to 8.5 inches" },
        { label: "Fingers per Cluster", val: "4 to 8 selected fingers" },
    ...
    mango: {
      ...
      specs_es: [
        ...
        { label: "Origen", val: "Guayas y Santa Elena, Ecuador" },
        { label: "Calibres Disponibles", val: "6, 7, 8, 9, 10, 12, 14 (300g a 700g/fruta)" },
        { label: "Nivel de Dulzura", val: "12° a 15° Grados Brix a la cosecha" },
        { label: "Tratamiento Fitosanitario", val: "Tratamiento Hidrotérmico en planta certificada USDA" },
      ...
      specs_en: [
        ...
        { label: "Sweetness Level", val: "12° to 15° Brix at packing" },
    ...
    pitahaya_roja: {
      ...
      badge: "High Antioxidant Superfruit",
      specs_es: [
        { label: "Especie Botánica", val: "Hylocereus monacanthus / polyrhizus" },
        { label: "Color de Pulpa", val: "Rojo / Púrpura intenso (Magenta)" },
        { label: "Calibres Comerciales", val: "6, 7, 8, 9, 10 (Peso: 350g a 700g por fruto)" },
        { label: "Nivel de Grados Brix", val: "12° a 14° Brix" },
        { label: "Presentación", val: "Cajas telescópicas de 4.0 kg o 4.5 kg neto con alveolos" },
        ...
        { label: "Disponibilidad", val: "Picos principales: Enero - Mayo y Agosto - Octubre" }
      ],
      specs_en: [
        { label: "Botanical Species", val: "Hylocereus monacanthus / polyrhizus" },
        { label: "Flesh Color", val: "Vibrant deep magenta red / purple" },
        { label: "Commercial Calibers", val: "6, 7, 8, 9, 10 (Weight: 350g to 700g each)" },
        { label: "Brix Level", val: "12° to 14° Brix" },
        { label: "Packaging", val: "Telescopic boxes 4.0 kg or 4.5 kg net with fruit trays" },
        ...
        { label: "Availability", val: "Main peaks: January - May and August - October" }
      ]
    },
    pitahaya_amarilla: {
      ...
      specs_es: [
        ...
        { label: "Dulzura Excepcional", val: "16° a 19° Grados Brix (Sabor a miel natural)" },
        { label: "Empaque", val: "Cajas de cartón de 2.5 kg, 4.0 kg y 4.5 kg neto" },
        { label: "Mercados Principales", val: "Estados Unidos, Canadá, Singapur, Hong Kong, Dubái" },
        { label: "Temperatura de Transporte", val: "10.0°C - 12.0°C en transporte refrigerado" },
        { label: "Beneficios Clave", val: "Alta en fibra soluble (captina), vitamina C y prebióticos" }
      ],
      specs_en: [
        ...
        { label: "Exceptional Sweetness", val: "16° to 19° Brix (Natural honeyed flavor)" },
        { label: "Packaging", val: "Corrugated master boxes 2.5 kg, 4.0 kg, and 4.5 kg net" },
        { label: "Key Export Destinations", val: "United States, Canada, Singapore, Hong Kong, Dubai" },
        { label: "Transit Temperature", val: "10.0°C - 12.0°C in temperature-controlled reefer" },
        { label: "Health Benefits", val: "Rich in soluble fiber (captin), Vitamin C, and prebiotics" }
      ]
    }
  };
  ...
  function openSpecsModal(productKey) {
    ...
    if (modalBtnQuote) {
      modalBtnQuote.onclick = () => {
        ...
        if (fruitSelect) {
          if (productKey === 'banano') fruitSelect.value = 'Banano Cavendish';
          if (productKey === 'mango') fruitSelect.value = 'Mango Tommy/Kent';
          if (productKey === 'pitahaya_roja') fruitSelect.value = 'Pitahaya Roja';
          if (productKey === 'pitahaya_amarilla') fruitSelect.value = 'Pitahaya Amarilla';
        }
      };
    }
  ...
  // Pre-select fruit on clicking "Cotizar" in card
  ...
  function buildWhatsAppMessage() {
    ...
    const fruit = document.getElementById('fruitSelect').value || 'Frutas Variadas';
    const volume = document.getElementById('volumeSelect').value || '1 Contenedor';
    const dest = document.getElementById('destCountry').value || 'Destino';
    const incoterm = document.getElementById('incotermSelect').value || 'FOB';
    const notes = document.getElementById('comments').value || 'Ninguna';
...
📝 *Requerimientos:* ${notes}`;
  ...
  if (btnSendWhatsapp) {
    btnSendWhatsapp.addEventListener('click', () => {
      ...
      const url = `https://wa.me/593999999999?text=${msg}`;
    ...
    quoteForm.addEventListener('submit', (e) => {
      ...
      setTimeout(() => {
        ...
        if (submitBtn) {
          ...
          submitBtn.innerHTML = '<i class="fa-solid fa-check"></i> ' + (currentLang === 'es' ? 'Enviado con Éxito' : 'Successfully Sent');
        }
        quoteForm.reset();
      }, 800);
    });
